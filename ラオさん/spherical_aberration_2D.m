...
l = -2;  % exp(i m theta) symmetry of input
...
max_output_radius = 75*10^-6; % m
output_radius_sample_number = 200;

distance_half_range = 1e-3; % /m
distance_start = f - distance_half_range;
distance_end = f + distance_half_range;   %  / m
...
z_samples = [f, f - 200e-6];    % select which z distances to plot
