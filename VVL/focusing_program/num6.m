...
M=5;n1=3; n2=3;
N1=2050; % number of points for the aperture radius
...
imp1=importdata('Image/6/0.csv'); imp_x=imresize(imp1,[fig_size fig_size]);imp_x(imp_x<0)=0;
%imp_x=g_filter(imp_x,10,5);

imp2=importdata('Image/6/90.csv'); imp_y=imresize(imp2,[fig_size fig_size]);imp_y(imp_y<0)=0;
...
col2 = [1932.*ratio 2087.*ratio];
row2 = [2000.*ratio 2004.*ratio];
...
boundary_y1(1)=2029; boundary_x1(1)=1/slope1.*(boundary_y1(1)-intercept1);
boundary_x2(1)=1968; boundary_y2(1)=boundary_x2(1)*slope2+intercept2;

boundary_y1(2)=1996; boundary_x1(2)=1/slope1.*(boundary_y1(2)-intercept1);
boundary_x2(2)=1996; boundary_y2(2)=boundary_x2(2)*slope2+intercept2;

boundary_y1(3)=1964; boundary_x1(3)=1/slope1.*(boundary_y1(3)-intercept1);
boundary_x2(3)=2025; boundary_y2(3)=boundary_x2(3)*slope2+intercept2;
