...
M=5;n1=2; n2=4;
N1=2300; % number of points for the aperture radius
...
imp1=importdata('Image/3/0.csv'); imp_x=imresize(imp1,[fig_size fig_size]);imp_x(imp_x<0)=0;
%imp_x=g_filter(imp_x,10,5);

imp2=importdata('Image/3/90.csv'); imp_y=imresize(imp2,[fig_size fig_size]);imp_y(imp_y<0)=0;
...
boundary_y1(1)=2012; boundary_x1(1)=1/slope1.*(boundary_y1(1)-intercept1);
boundary_x2(1)=1947; boundary_y2(1)=boundary_x2(1)*slope2+intercept2;
...
csvwrite("tightly_focused_image/num5/Exf.csv",Exf); %csvで書き出し
csvwrite("tightly_focused_image/num5/Eyf.csv",Eyf); %csvで書き出し
csvwrite("tightly_focused_image/num/Ezf.csv",Ezf); %csvで書き出し
