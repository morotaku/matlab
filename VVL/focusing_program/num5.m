...
M=5;n1=4; n2=4;
N1=2450; % number of points for the aperture radius
...
imp1=importdata('Image/5/0.csv'); imp_x=imresize(imp1,[fig_size fig_size]);imp_x(imp_x<0)=0;
%imp_x=g_filter(imp_x,10,5);

imp2=importdata('Image/5/90.csv'); imp_y=imresize(imp2,[fig_size fig_size]);imp_y(imp_y<0)=0;
...
%% Linear fitting
figure(2)
col1 = [2000.*ratio 2001.*ratio];
row1 = [2092.*ratio 1906.*ratio];
col2 = [1917.*ratio 2087.*ratio];
...
boundary_y1(1)=2041; boundary_x1(1)=1/slope1.*(boundary_y1(1)-intercept1);
boundary_x2(1)=1958; boundary_y2(1)=boundary_x2(1)*slope2+intercept2;

boundary_y1(2)=2009; boundary_x1(2)=1/slope1.*(boundary_y1(2)-intercept1);
boundary_x2(2)=1987; boundary_y2(2)=boundary_x2(2)*slope2+intercept2;

boundary_y1(3)=1980; boundary_x1(3)=1/slope1.*(boundary_y1(3)-intercept1);
boundary_x2(3)=2013; boundary_y2(3)=boundary_x2(3)*slope2+intercept2;
