...
M=5;n1=2; n2=1;
N1=1450; % number of points for the aperture radius
...
imp1=importdata('Image/2/0.csv'); imp_x=imresize(imp1,[fig_size fig_size]);imp_x(imp_x<0)=0;
%imp_x=g_filter(imp_x,10,5);

imp2=importdata('Image/2/90.csv'); imp_y=imresize(imp2,[fig_size fig_size]);imp_y(imp_y<0)=0;
...
col2 = [1993.*ratio 2087.*ratio];
row2 = [1993.*ratio 2004.*ratio];
...
boundary_y1(1)=2010; boundary_x1(1)=1/slope1.*(boundary_y1(1)-intercept1);
boundary_x2(1)=1996; boundary_y2(1)=boundary_x2(1)*slope2+intercept2;

boundary_y1(2)=1977; boundary_x1(2)=1/slope1.*(boundary_y1(2)-intercept1);
