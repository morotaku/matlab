...
img1=importdata('Image/1/0.csv');
img2=importdata('Image/1/90.csv');
img1=img1./max(max(img1));
img2=img2./max(max(img2));
img_size1=size(img1);
img_size2=size(img2);
img_bin1=img1>0.5; %binarize
img_bin2=img2>0.5;
...
boundary_y1(1)=99; boundary_x1(1)=1/slope1.*(boundary_y1(1)-intercept1);
boundary_x2(1)=100; boundary_y2(1)=boundary_x2(1)*slope2+intercept2;
...
figure(4)
subplot(1,2,1);imagesc(angle(phase1));axis image;axis xy;colormap jet; xlim([0 img_size1(1)]);ylim([0 img_size1(1)]);
subplot(1,2,2);imagesc(angle(phase2));axis image;axis xy;colormap jet; xlim([0 img_size1(1)]);ylim([0 img_size1(1)]);
axis xy
