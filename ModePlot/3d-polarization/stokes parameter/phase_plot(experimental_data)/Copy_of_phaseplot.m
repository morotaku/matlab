...
img1=importdata('4/0.csv');
img2=importdata('4/90.csv');
img1=img1./max(max(img1));
img2=img2./max(max(img2));
img_size1=size(img1);
img_size2=size(img2);
img_bin1=img1>0.9; %binarize
img_bin2=img2>0.5;
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
boundary_x1(1)=222.5; boundary_y1(1)=boundary_x1(1)*slope1+intercept1;
boundary_x2(1)=115; boundary_y2(1)=boundary_x2(1)*slope2+intercept2+0;

boundary_x1(2)=252.5; boundary_y1(2)=boundary_x1(2)*slope1+intercept1;
boundary_x2(2)=185; boundary_y2(2)=boundary_x2(2)*slope2+intercept2;
% 
% boundary_x1(3)=315; boundary_y1(3)=boundary_x1(3)*slope1+intercept1;
boundary_x2(3)=262.5; boundary_y2(3)=boundary_x2(3)*slope2+intercept2;
% 
...
subplot(1,2,2);imagesc(angle(phase2));axis image;axis xy;colormap jet; colorbar;
axis xy
...
phase_dif=g_filter(phase_dif,51,15);
...
I00=img1;
I90=img2;
I45=importdata('4/45.csv');
I135=importdata('4/135.csv');
...
s3_sign=g_filter(s3_sign,51,15);
s3_n=s3_n.*s3_sign;
