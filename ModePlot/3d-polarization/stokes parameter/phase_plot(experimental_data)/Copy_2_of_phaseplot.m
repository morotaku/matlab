...
img1=importdata('5/0.csv');
img2=importdata('5/90.csv');
img1=img1./max(max(img1));
img2=img2./max(max(img2));
img_size1=size(img1);
img_size2=size(img2);
img_bin1=img1>0.65; %binarize
img_bin2=img2>0.6;
...
boundary_x1(2)=222.5; boundary_y1(2)=boundary_x1(2)*slope1+intercept1;
boundary_x2(2)=225; boundary_y2(2)=boundary_x2(2)*slope2+intercept2;
% 
boundary_x1(3)=257.5; boundary_y1(3)=boundary_x1(3)*slope1+intercept1;
...
I00=img1;
I90=img2;
I45=importdata('5/45.csv');
I135=importdata('5/135.csv');
...
s3_sign=g_filter(s3_sign,71,15);
s3_n=s3_n.*s3_sign;
