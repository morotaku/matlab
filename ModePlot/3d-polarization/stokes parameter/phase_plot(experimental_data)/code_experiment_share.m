...
IGB=rot90(IGB,-1);
% IGB=abs(IGB.^2);
e_h=HGmode_45(4,x,y,r,w,z,zr,k,R);

i_h=abs(e_h.*conj(e_h));
e_v=IGB;%hgmode(3,0,x,y,w,z,R,k);
%e_v=hgmode(0,3,x,y,w,z,R,k);+8.*hgmode(2,1,x,y,w,z,R,k)+8.*hgmode(1,2,x,y,w,z,R,k)+hgmode(0,3,x,y,w,z,R,k);
