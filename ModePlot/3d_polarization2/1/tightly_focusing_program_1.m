...
M=5;n1=4; n2=4;
N1=2200; % number of points for the aperture radius
...
%% Linear fitting
figure(2)
col1 = [1970.*ratio 2026.*ratio];
row1 = [2072.*ratio 1926.*ratio];
col2 = [1937.*ratio 2058.*ratio];
row2 = [1976.*ratio 2038.*ratio];
...
boundary_x1(1)=1984.*ratio; boundary_y1(1)=boundary_x1(1)*slope1+intercept1;
boundary_x2(1)=1965.*ratio; boundary_y2(1)=boundary_x2(1)*slope2+intercept2;

boundary_x1(2)=1994.5.*ratio; boundary_y1(2)=boundary_x1(2)*slope1+intercept1;
boundary_x2(2)=1988.*ratio; boundary_y2(2)=boundary_x2(2)*slope2+intercept2;

boundary_x1(3)=2004.*ratio; boundary_y1(3)=boundary_x1(3)*slope1+intercept1;
boundary_x2(3)=2006.*ratio; boundary_y2(3)=boundary_x2(3)*slope2+intercept2;

boundary_x1(4)=2014.*ratio; boundary_y1(4)=boundary_x1(4)*slope1+intercept1;
boundary_x2(4)=2030.*ratio; boundary_y2(4)=boundary_x2(4)*slope2+intercept2;
