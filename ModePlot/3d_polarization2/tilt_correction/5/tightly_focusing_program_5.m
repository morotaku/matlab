...
M=5;n1=3; n2=3;
N=2750; % number of points for the aperture radius
...
imp1=importdata('0.csv'); imp1=imresize(imp1,[300 300]);
imp_x=abs(sqrt(imp1)); imp_x=imp_x./max(max(imp_x));
imp_x=g_filter(imp_x,10,5);

imp2=importdata('90.csv'); imp2=imresize(imp2,[300 300]);
...
boundary_x1(1)=2681; boundary_y1(1)=boundary_x1(1)*slope1+intercept1;
boundary_x2(1)=2661; boundary_y2(1)=boundary_x2(1)*slope2+intercept2;

boundary_x1(2)=2703; boundary_y1(2)=boundary_x1(2)*slope1+intercept1;
boundary_x2(2)=2703; boundary_y2(2)=boundary_x2(2)*slope2+intercept2;

boundary_x1(3)=2725; boundary_y1(3)=boundary_x1(3)*slope1+intercept1;
boundary_x2(3)=2749; boundary_y2(3)=boundary_x2(3)*slope2+intercept2;
