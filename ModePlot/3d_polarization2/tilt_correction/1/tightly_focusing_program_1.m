...
imp_x=rotate(imp_x,22.5);
imp_y=rotate(imp_y,22.5);
...
figure(1)
subplot(1,2,1);imagesc(e_incx);axis image;colormap jet; axis xy;
subplot(1,2,2);imagesc(e_incy);axis image;colormap jet; axis xy;
