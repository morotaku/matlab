...
M=5;n1=2; n2=4;
N=1600; % number of points for the aperture radius
range=110000; %display range
L=4000;
ratio=2;
fig_size=round(L*300/5400); %Inputビームの画像サイズ変更
...
%% Linear fitting
figure(2)
col1 = [995.*ratio 1004.*ratio];
row1 = [1016.*ratio 984.*ratio];
col2 = [990.*ratio 1032.*ratio];
row2 = [997.*ratio 1009.*ratio];
...
boundary_x1(1)=1996; boundary_y1(1)=boundary_x1(1)*slope1+intercept1;
boundary_x2(1)=1996; boundary_y2(1)=boundary_x2(1)*slope2+intercept2;

boundary_x1(2)=2002.5; boundary_y1(2)=boundary_x1(2)*slope1+intercept1;
boundary_x2(2)=2012; boundary_y2(2)=boundary_x2(2)*slope2+intercept2;

%boundary_x1(3)=2714; boundary_y1(3)=boundary_x1(3)*slope1+intercept1;
boundary_x2(3)=2030; boundary_y2(3)=boundary_x2(3)*slope2+intercept2;

% boundary_x1(4)=350; boundary_y1(4)=boundary_x1(4)*slope1+intercept1;
boundary_x2(4)=2044; boundary_y2(4)=boundary_x2(4)*slope2+intercept2;
