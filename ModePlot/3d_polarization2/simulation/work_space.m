...
n2=1.5; % refractive index for reflected field (immersion oil)
n3=1.5; % refractive index for transmitted field (after interface)
e1=n2^2;
e2=n3^2;
...
figure(1)
subplot(1,3,1);imagesc(abs(Fieldxxf));axis("equal"); subplot(1,3,2);imagesc(abs(Fieldxyf));axis("equal"); subplot(1,3,3);imagesc(abs(Fieldxzf));axis("equal");
...
%%% Plarization strip1
figure(3);
fontsize(3,15,"points");title('Polarization strip 1')
xrange1=strip1.*1.4; yrange1=strip1.*1.4; zrange1=3;
...
xlim([Ran/2-xrange1 Ran/2+xrange1]);ylim([Ran/2-yrange1 Ran/2+yrange1]);zlim([-3 zrange1]);
xlabel('x');ylabel('y');zlabel('z');

%%% Plarization strip2
figure(4)
fontsize(4,15,"points");title('Polarization strip 2')
xrange2=strip2*1.4; yrange2=strip2.*1.4; zrange2=6;
...
%%% Plarization strip3
figure(5)
fontsize(5,15,"points");title('Polarization strip 3')
xrange3=strip3*1.4; yrange3=strip3*1.4; zrange3=4;
