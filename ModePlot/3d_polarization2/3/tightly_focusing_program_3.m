...
M=5;n1=2; n2=1;
N=1100; % number of points for the aperture radius
...
col2 = [1976.*ratio 2023.*ratio];
row2 = [1984.*ratio 2017.*ratio];
...
boundary_x1(1)=1995.*ratio; boundary_y1(1)=boundary_x1(1)*slope1+intercept1;
boundary_x2(1)=2000.*ratio; boundary_y2(1)=boundary_x2(1)*slope2+intercept2;

boundary_x1(2)=2003.*ratio; boundary_y1(2)=boundary_x1(2)*slope1+intercept1;
