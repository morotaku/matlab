...
hg=HGmode(0,1,x,y,w,r,z,R,k)+exp(1j.*pi./2).*HGmode(1,0,x,y,w,r,z,R,k);%+8.*HGmode(2,1,x,y,w,r,z,R,k)+8.*HGmode(1,2,x,y,w,r,z,R,k)+HGmode(0,3,x,y,w,r,z,R,k);
HG=hg.*conj(hg);
HG_n=HG./max(max(HG));
HG_a=angle(hg);
HG_a(HG_a<0)=HG_a(HG_a<0)+2*pi;
