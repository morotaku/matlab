...
OUTPUTS:
    IGB = Ince Gaussian Beam (I-1ntensity is analytically normalized to 1, i.e., Integral(|IGB|^2)=1)
...
For more information about Ince Polynomial:
    Miguel A. Bandres and Julio C. Guti�rrez-Vega, "Ince-Gaussian modes of the paraxial wave equation and stable resonators"
    Journal of the Optical Society of America A, 21(5), 873-880 (2004) ( http://goo.gl/rqq7nQ )
AUTHOR: Miguel A. Bandres
URL:    www.mabandres.com
%}
